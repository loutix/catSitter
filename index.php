...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Votre tranquillité d'esprit, leur bonheur assuré !</div>
                <div class="masthead-heading text-uppercase">Garde chats Chien Castres</div>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Je suis une jeune retraitée résidant à Castres, qui propose de prendre soins de vos animaux en votre absence.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Je prends soin de vos chats et chiens chez vous, en leur apportant nourriture, câlins et jeux pendant votre absence.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Des balades régulières pour vos chiens afin de les garder actifs, heureux et en bonne santé.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        ...
                        <p class="text-muted">Je vous envoie des photos et des nouvelles de vos animaux après chaque visite, pour vous rassurer et partager leur quotidien.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading text-muted">chat tigré</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                                ...
                                <img class="img-fluid" src="assets/img/portfolio/chat4.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
        ...
        <div class="container mt-5" id="contact">
            ...
            <!-- Bouton Envoyer -->
            <div class="text-center">
                <button type="submit" name="submitContact" class="btn btn-primary my-2">Envoyer message</button>
            </div>
        </form>
    </div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; Loutix WebMAster </div>
                </div>
            </div>
        </footer>
        <!-- Portfolio Modals-->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">Project Name</h2>
                                    <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                    <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/chat4.jpg" alt="..." />
                                    <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                                    <ul class="list-inline">
                                        <li>
                                            <strong>Client:</strong>
